...
def func_transformador():
    ...
    consumidor = kafka.KafkaConsumer('topico-datos-crudos', bootstrap_servers= [IP_server + ':9092'], group_id='mi-grupo-consumidores', value_deserializer=lambda x: loads(x.decode('utf-8')),  client_id='mi-consumidor-transformador')
    ...
    while True:
        ...
        for msg in consumidor:
            ...
            print(msg)
            productor.send('topico-datos-procesados', b'Hi') # b'Hola'
            # productor.flush()
